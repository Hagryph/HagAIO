...
function PanelW:Initialize(parent, bgKey, borderKey, opts)
    opts = opts or {}
    local f = CreateFrame("Frame", nil, unwrap(parent), "BackdropTemplate")
    surface(f, {
        bgKey = bgKey or "surface", borderKey = borderKey or "border",
        shadow = opts.shadow, highlight = opts.highlight, accent = opts.accent,
