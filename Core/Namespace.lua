...
ns.FlightGraph = nil    -- flight-route path costs (pure) (Services/FlightGraph.lua)
ns.Geometry = nil       -- 2D distance / nearest (pure)  (Services/Geometry.lua)
ns.SpellTooltipParser = nil -- spell-description number parse (Services/SpellTooltipParser.lua)
ns.CVarHelper = nil     -- CVar type inference (pure)    (Services/CVarHelper.lua)
