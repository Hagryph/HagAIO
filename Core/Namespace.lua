...
ns.FlightGraph = nil    -- LIB: flight-route path costs  (Services/FlightGraph.lua)
ns.Geometry = nil       -- LIB: 2D distance / nearest    (Services/Geometry.lua)
ns.SpellTooltipParser = nil -- LIB: spell-desc number parse (Services/SpellTooltipParser.lua)
ns.CVarHelper = nil     -- LIB: CVar type inference      (Services/CVarHelper.lua)
