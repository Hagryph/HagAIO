...
local HunterBase = Class.new("HunterBase", ns.ClassSpec, { statics = { settings = {
    { type = "header", text = "Post-Cast Focus" },
    { type = "toggle", key = "steadyCastFill", label = "Show prediction", default = true,
      desc = "While casting Steady Shot, show the Focus you will have when it finishes." },
    { type = "color", key = "steadyCastColor", label = "Colour",
      default = Hunter.SteadyCastColor(), dependsOn = "steadyCastFill" },
    { type = "divider" },
    { type = "header", text = "Steady Shot Focus Gain" },
    { type = "toggle", key = "steadyShot", label = "Show Focus gain", default = true,
      desc = "Show the Focus generated by Steady Shot as an additional segment." },
    { type = "color", key = "steadyColor", label = "Colour",
